                    ...
                    ? appButtons(
                        ...
                        anyWayDoor: () {
                          if (!isDateDone || !isTimeDone) {
                            ...
                            debugPrint(
                                'selected date day is ->$selectedDateDay');
